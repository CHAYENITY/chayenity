...
def upgrade() -> None:
    ...
    sa.Column('condition', sa.Enum('NEW', 'USED_LIKE_NEW', 'USED_GOOD', 'USED_FAIR', name='itemcondition'), nullable=False),
    sa.Column('status', sa.Enum('AVAILABLE', 'RESERVED', 'SOLD', name='itemstatus'), nullable=False),
    ...
    sa.Column('type', sa.Enum('NEW_MESSAGE', 'ITEM_INTEREST', 'PRICE_CHANGE', 'REVIEW_RECEIVED', 'REPORT_RESPONSE', name='notificationtype'), nullable=False),
    ...
    sa.Column('reason', sa.Enum('SPAM', 'INAPPROPRIATE', 'SCAM', 'FAKE_ITEM', 'OTHER', name='reporttype'), nullable=False),
