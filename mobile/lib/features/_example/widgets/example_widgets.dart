            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  _TaskCheckbox(task: task, isDisabled: isDisabled),
                  ...
                  // Status badge
                  _TaskStatusBadge(isCompleted: task.isCompleted),
                ],
              ),
              ...
              Row(
                children: [
                  ...
                  _TaskActions(task: task, isDisabled: isDisabled),
                ],
              ),
            ],
          ),
...
class _TaskCheckbox extends ConsumerWidget {
  ...
  const _TaskCheckbox({required this.task, required this.isDisabled});
...
/// 🏷️ Task Status Badge Widget (static)
class _TaskStatusBadge extends StatelessWidget {
  final bool isCompleted;

  const _TaskStatusBadge({required this.isCompleted});
...
/// 🎬 Task Actions Widget (static)
class _TaskActions extends ConsumerWidget {
  final Task task;
  final bool isDisabled;

  const _TaskActions({required this.task, required this.isDisabled});
